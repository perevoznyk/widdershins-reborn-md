...
/** Convert a Semoasa definition to Markdown or HTML. @param {object} api - Semoasa definition object. @param {object} options - Conversion options. @returns {Promise<string>} Generated Markdown or HTML. */
function convert(api, options) {
  return new Promise(function (resolve, reject) {
    ...
    if (typeof templates === 'undefined') {
      templates = require('./templates/semoasa');
    }
