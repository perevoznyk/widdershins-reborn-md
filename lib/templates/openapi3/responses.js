...
module.exports = function anonymous(data) {
  ...
  if (data.responseSchemas) {
    out +=
      '\n<h3 id="' +
      data.operationUniqueSlug +
      '-responseschema">Response Schema</h3>\n';
    var arr4 = data.responses;
    if (arr4) {
      var response,
        i4 = -1,
        l4 = arr4.length - 1;
              ...
              if (arr7) {
                ...
                while (i7 < l7) {
                  ...
                  out +=
                    ...
                    e.name +
                    '|' +
                    data.utils.toPrimitive(e.value) +
                    '|\n';
                }
              }
              out += '\n\n';
