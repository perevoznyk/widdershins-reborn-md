...
/** Convert an AsyncAPI 1.x definition to Markdown or HTML. @param {object} api - AsyncAPI 1.x definition object. @param {object} options - Conversion options. @returns {Promise<string>} Generated Markdown or HTML. */
